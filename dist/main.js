...
const projectListView = (() => {
    ...
    _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('selectFirstOne', () => {
        ...
        _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('projectSelected', firstProjectDOM.dataset.id)
    })
...
const Controller = (() => {
    ...
    function setItems() {
        ...
        console.log(_logic__WEBPACK_IMPORTED_MODULE_0__.ProjectList.getList().length)
