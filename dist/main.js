...
const Controller = (() => {
    ...
    function populateStorage() {
        ...
        ;(0,_logic__WEBPACK_IMPORTED_MODULE_0__.ls)('currentProjectID', newProjectID)
        ;(0,_logic__WEBPACK_IMPORTED_MODULE_0__.ls)('currentTaskID', newTaskID)
    ...
    function setItems() {
        ...
        const currentProjectList = (0,_logic__WEBPACK_IMPORTED_MODULE_0__.ls)('projectList')
        const currentTaskID = (0,_logic__WEBPACK_IMPORTED_MODULE_0__.ls)('currentTaskID')
        const currentProjectID = (0,_logic__WEBPACK_IMPORTED_MODULE_0__.ls)('currentProjectID')
    ...
    _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('infoChanged', (data, topic) => {
        localStorage.setItem('projectList2',  JSON.stringify(_logic__WEBPACK_IMPORTED_MODULE_0__.ProjectList.list))
        console.log('actual list: ', _logic__WEBPACK_IMPORTED_MODULE_0__.ProjectList.list)
        ;(0,_logic__WEBPACK_IMPORTED_MODULE_0__.ls)('projectList', _logic__WEBPACK_IMPORTED_MODULE_0__.ProjectList.getList()[0])
