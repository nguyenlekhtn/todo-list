...
const Controller = (() => {
    ...
    function loadProject(id) {
        ...
        _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('changeProjectInList', projectSelected)
    ...
    _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('taskCompletedChanged', (task, topic) => {
    ...
    _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('taskDOMremoved', (task, info) => {
        console.log({task})
        console.log({currentProject})
    ...
    function parseProjectList(projectArr) {
        for(let i = 0; i < projectArr.length; i++) {
            ...
            for(let i = 0; i< taskArr.length; i++) {
                ...
                const richTask = (0,_logic__WEBPACK_IMPORTED_MODULE_0__.Task)(plainTask.id, plainTask.name, plainTask.dueDate, plainTask.isCompleted)
                taskArr[i] = richTask
            }
