...
/* harmony export */   "pubsub": () => (/* reexport safe */ _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub)
/* harmony export */ });
...
const projectListView = (() => {
    ...
    _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('changeProjectInList', (project, info) => {
    ...
    function selectProjectDOM(DOM) {
        ...
        _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('projectSelected', DOM.dataset.projectid)
    }
...
const TaskDOM = (task) => {
    ...
    check.addEventListener('click', e => {
        ...
        _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('taskCompletedChanged', task)
    })
    ...
    binIcon.addEventListener('click', e => {
        console.log({task})
        _logic__WEBPACK_IMPORTED_MODULE_0__.pubsub.publishSync('taskDOMremoved', task)
        taskDOM.remove()
    })
...
const Controller = (() => {
    ...
    if (!_logic__WEBPACK_IMPORTED_MODULE_1__.ls.get('projectList'))
    {
        populateStorage()
    }
    else {
    ...
    function populateStorage() {
        ...
        const defaultProject = (0,_logic__WEBPACK_IMPORTED_MODULE_1__.Project)(defaultProjectID, defaultProjectName, "")
        _logic__WEBPACK_IMPORTED_MODULE_1__.ProjectList.addProject(defaultProject)
        currentProject = defaultProject
        const defaultTaskID = 0
        const defaultTask = (0,_logic__WEBPACK_IMPORTED_MODULE_1__.Task)(0, defaultTaskName, defaultDate)
    ...
    function setItems() {
        const plainProjectArr = (0,_logic__WEBPACK_IMPORTED_MODULE_1__.ls)('projectList')
        const richProjectArr = parseProjectList(plainProjectArr)
        
        const lastProjectID = (0,_logic__WEBPACK_IMPORTED_MODULE_1__.ls)('currentProjectID')
        const lastTaskID = (0,_logic__WEBPACK_IMPORTED_MODULE_1__.ls)('currentTaskID')

        richProjectArr.forEach(project => {
            _logic__WEBPACK_IMPORTED_MODULE_1__.ProjectList.addProject(project)
        })
    ...
    if (_logic__WEBPACK_IMPORTED_MODULE_1__.ProjectList.getList().length != 0) {
        loadFirstProjectInView()
    }
    
    function loadFirstProjectInView() {
        currentProject = _logic__WEBPACK_IMPORTED_MODULE_1__.ProjectList.getList()[0]
    ...
    _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe("newInfoSubmitted", (data, info) => {
        
        const newProject = (0,_logic__WEBPACK_IMPORTED_MODULE_1__.Project)(newProjectID++, data.name, data.description)
        _logic__WEBPACK_IMPORTED_MODULE_1__.ProjectList.addProject(newProject)
        loadProject(newProject.getProjectInfo().id)
    })
    
    _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe('projectSelected', (id, info) => {
        loadProject(id)
    })

    function loadProject(id) {
        
        const projectSelected = _logic__WEBPACK_IMPORTED_MODULE_1__.ProjectList.findProject(id)
        
        if(!projectSelected) {
            currentProject = projectSelected
        }
        _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.publish('changeProject', projectSelected)
        _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.publish('changeProjectInList', projectSelected)
        _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.publish('loadTaskList', projectSelected.getProjectInfo().list)
    }

    _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe('projectInfoSubmitted', ({title, description},info) => {
        currentProject.setProjectInfo(title, description)
        
    })
    

    _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe('taskInfoSubmitted', ({task, title, dueDate}, info) => {
        task.setTaskInfo(title, dueDate)
    })

    _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe('newTaskSubmitted', ({title, dueDate}, topic) => {
        const newTask = (0,_logic__WEBPACK_IMPORTED_MODULE_1__.Task)(newTaskID++, title, dueDate)
        currentProject.addTask(newTask)
    })

    _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe('taskCompletedChanged', (task, topic) => {
        task.toggleCompleted()
    })

    _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe('infoChanged', (data, topic) => {
        ;(0,_logic__WEBPACK_IMPORTED_MODULE_1__.ls)('projectList', _logic__WEBPACK_IMPORTED_MODULE_1__.ProjectList.getList())
    })

    _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe('removeCurrentProject', () => {
        const current = currentProject
        _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.publishSync('removeProjectDOM', current)
        loadFirstProjectInView()
    })

    _logic__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe('taskDOMremoved', (task, info) => {
        console.log({task})
        console.log({currentProject})
    ...
    function parseProjectList(projectArr) {
        for(let i = 0; i < projectArr.length; i++) {
            ...
            const richProject = (0,_logic__WEBPACK_IMPORTED_MODULE_1__.Project)(plainProject.id, plainProject.name, plainProject.description)
            const taskArr = plainProject.list
            for(let i = 0; i< taskArr.length; i++) {
                const plainTask = taskArr[i]
                const richTask = (0,_logic__WEBPACK_IMPORTED_MODULE_1__.Task)(plainTask.id, plainTask.name, plainTask.dueDate, plainTask.isCompleted)
                taskArr[i] = richTask
            }
